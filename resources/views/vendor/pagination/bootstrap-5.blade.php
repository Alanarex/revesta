    ...
    <nav class="d-flex flex-column align-items-center gap-3">
        ...
        <div class="d-flex justify-content-between flex-fill d-sm-none w-100">
            <ul class="pagination mb-0">
                ...
                @else
                    <li class="page-item">
                        <a class="page-link" href="{{ $paginator->previousPageUrl() }}" rel="prev">Précedent</a>
                    </li>
                @endif
            ...
            <div class="d-flex flex-column justify-content-center align-items-center gap-2">
                ...
                <div class="d-flex justify-content-center align-items-center">
                    <ul class="pagination mb-0">
                        {{-- Previous Page Link --}}
                        @if ($paginator->onFirstPage())
                            <li class="page-item disabled" aria-disabled="true" aria-label="Précedent">
                                <span class="page-link" aria-hidden="true">&lsaquo;</span>
                            </li>
                        @else
                            <li class="page-item">
                                <a class="page-link" href="{{ $paginator->previousPageUrl() }}" rel="prev"
                                    aria-label="Précedent">&lsaquo;</a>
                            </li>
                        @endif
